...
> **참고**: UI 컴포넌트는 TDD 제외. 수동 테스트 또는 Storybook 사용.
...
**작업 내용**:
- [ ] `tests/integration/calculator-flow.test.tsx` 작성
  - [ ] 기본 계산 플로우
  - [ ] 공학 함수 플로우
  - [ ] 히스토리 저장 플로우
- [ ] `tests/integration/converter-flow.test.tsx` 작성
- [ ] `tests/integration/history-flow.test.tsx` 작성
